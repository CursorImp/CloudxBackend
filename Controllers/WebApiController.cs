...
namespace SignalRHub.Controllers
{
 ...
 && (a.DriverWorkStatusId != Enums.Driver_WORKINGSTATUS.AVAILABLE && a.DriverWorkStatusId != Enums.Driver_WORKINGSTATUS.ONBREAK)
    ...
    && obj.advancebookingInfo.BookingReturn.Ids.Any())
        ...
        [System.Web.Http.HttpGet]
        [System.Web.Http.HttpPost]
        [System.Web.Http.Route("SendOnlineBookingmail")]
        public JsonResult SendOnlineBookingmail(WebApiClasses.RequestWebApi obj)
        {
            try
            {
                System.IO.File.AppendAllText(AppContext.BaseDirectory + "\\" + "SendOnlineBookingmail.txt", DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss") + ",json:" + new JavaScriptSerializer().Serialize(obj) + Environment.NewLine);
            }
            catch
            {
            ...
            try
            {
                using (TaxiDataContext db = new TaxiDataContext())
                {
                    ...
                    if (obj2 != null)
                    {
                        ...
                        if (obj2.BookingStatusId.ToInt() == 1)
                        {
                            //StrBld.Append("<div style='font-family: Calibri, Arial; font-size: 13px; color: #333; line-height: 1.5;'>");

                            //// Header
                            //StrBld.Append("<div style='text-align: center; margin-bottom: 20px; border-bottom: 1px solid #eee; padding-bottom: 20px;'>");
                            //StrBld.Append("<h1 style='color: #2c3e50; font-size: 24px; margin-bottom: 5px;'>eTicket Order</h1>");
                            //StrBld.Append("<h2 style='color: #3498db; font-size: 20px; margin-bottom: 15px;'>" + objSubCompany.CompanyName + "</h2>");
                            //StrBld.Append("</div>");

                            //// Greeting and message
                            //StrBld.Append("<p>Dear " + obj2.CustomerName.ToStr() + ",</p>");
                            //StrBld.Append("<p>We're happy to inform you that your taxi booking has been confirmed. Below are your ride details.</p>");
                            //StrBld.Append("<p style='font-style: italic; margin: 15px 0;'>Our online bookings are open 24/7 days a week</p>");

                            //// Main booking table
                            //StrBld.Append("<table width='100%' border='0' cellspacing='0' cellpadding='8' style='border-collapse: collapse; font-family: Arial; font-size: 14px; color: #333; margin: 20px 0; border: 1px solid #d4e0ee;'>");

                            //// Order No row
                            StrBld.Append("<div style='font-family: Calibri, Arial; font-size: 13px; color: #333; line-height: 1.5;'>");

                            // Main header table with greyish outer border only
                            StrBld.Append("<table width='100%' border='0' cellspacing='0' cellpadding='10' style='border-collapse: collapse; border: 1px solid #d4e0ee; margin-bottom: 20px;'>");

                            // First row: eTicket Order and Company Name
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='font-size: 18px; font-weight: bold; border: 1px solid #d4e0ee;color:#FF0000'>eTicket Order</td>");
                            StrBld.Append("<td align='center' style='font-size: 18px; font-weight: bold;border: 1px solid #d4e0ee;color:#660033'>" + objSubCompany.CompanyName+"</td>");                            
                            StrBld.Append("</tr>");

                            // Second row: Greeting and message
                            StrBld.Append("<tr>");
                            StrBld.Append("<td colspan='2' style='color: #6CB6D9;font-size:18px; text-align: center; border: 1px solid #d4e0ee; padding-top: 5px;'>Dear " + obj2.CustomerName.ToStr() + ", We're happy to inform you that your taxi booking has been confirmed. Below are your ride details.</td>");
                            StrBld.Append("</tr>");

                            // Third row: Online bookings note
                            StrBld.Append("<tr>");
                            StrBld.Append("<td colspan='2' style='font-weight: bold;font-size:18px; text-align: center; border: 1px solid #d4e0ee; padding-top: 5px;'>Our online bookings are open 24/7 days a week</td>");
                            StrBld.Append("</tr>");
                            ...
                            StrBld.Append("<tr>");
                            StrBld.Append("<td colspan='2' style='border: 1px solid #d4e0ee; font-weight: bold; background-color: #f3f6fa;'>ORDER NO:</td>");
                            StrBld.Append("<td colspan='2' style='border: 1px solid #d4e0ee;font-weight:bold;color:#006400'>" + obj2.BookingNo.ToString() + "</td>");
                            //StrBld.Append("<td width='25%' style='border: 1px solid #d4e0ee; font-weight: bold; background-color: #f3f6fa;'></td>");
                            //StrBld.Append("<td width='25%' style='border: 1px solid #d4e0ee;'></td>");
                            StrBld.Append("</tr>");

                            // Traveller Information section
                            StrBld.Append("<tr>");
                            StrBld.Append("<td colspan='2' style='border: 1px solid #d4e0ee; font-weight: bold; background-color: #f3f6fa;'>Traveller Information</td>");
                            StrBld.Append("<td colspan='2' style='border: 1px solid #d4e0ee; font-weight: bold; background-color: #f3f6fa;'>Carrier Details</td>");
                            StrBld.Append("</tr>");

                            // Name and Passenger No
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>Name:</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee;'>" + obj2.CustomerName + "</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>Passenger No:</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee;'>" + obj2.CustomerMobileNo + "</td>");
                            StrBld.Append("</tr>");

                            // Email and Hand Luggage
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>Email Address:</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee;'>" + obj2.CustomerEmail + "</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>Hand Luggage:</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee;'>" + obj2.NoofHandLuggages.ToInt() + "</td>");
                            StrBld.Append("</tr>");

                            // Vehicle and Check-in Luggage
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>Vehicle:</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee;'>" + obj2.Fleet_VehicleType.VehicleType.ToStr() + "</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>Check-in Luggage:</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee;'>" + obj2.NoofLuggages.ToInt() + "</td>");
                            StrBld.Append("</tr>");

                            // Phone Number and Special Instructions
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>Phone Number:</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee;'>" + obj2.CustomerPhoneNo + "</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>Special Ins:</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee;'>" + obj2.SpecialRequirements + "</td>");
                            StrBld.Append("</tr>");

                            // Pick-up and Drop-off headers
                            StrBld.Append("<tr>");
                            StrBld.Append("<td colspan='2' style='border: 1px solid #d4e0ee; font-weight: bold; background-color: #f3f6fa;'>Pick-up Information</td>");
                            StrBld.Append("<td colspan='2' style='border: 1px solid #d4e0ee; font-weight: bold; background-color: #f3f6fa;'>Drop-off Information</td>");
                            StrBld.Append("</tr>");

                            // From and To addresses
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>From:</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee;'>" + obj2.FromAddress + "</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>To:</td>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee;'>" + obj2.ToAddress + "</td>");
                            StrBld.Append("</tr>");

                            // From Door No and empty cell
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>From Door No:</td>");
                            StrBld.Append("<td colspan='1' style='border: 1px solid #d4e0ee;'>" + obj2.FromDoorNo + "</td>");
                            StrBld.Append("</tr>");

                            // Pick Up Date row (spans all columns)
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>Pick Up Date:</td>");
                            StrBld.Append("<td colspan='1' style='border: 1px solid #d4e0ee;'>" + string.Format("{0:dd MMMM yyyy}", obj2.PickupDateTime) + "</td>");
                            StrBld.Append("</tr>");

                            // Pick Up Time row (spans all columns)
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='border: 1px solid #d4e0ee; font-weight: bold;'>Pick Up Time:</td>");
                            StrBld.Append("<td colspan='1' style='border: 1px solid #d4e0ee;'>" + string.Format("{0:HH:mm}", obj2.PickupDateTime) + "</td>");
                            StrBld.Append("</tr>");
                            ...
                            // Closing message
                            StrBld.Append("<p style='font-style: arial;font-bold;font-weight:bold;font-size:18px; margin: 20px 0; padding: 10px; border-top: 1px solid #eee;'>Thank you for choosing" + objSubCompany.CompanyName + ". We look forward to getting you to your destination safely and comfortably.Best regards," + objSubCompany.CompanyName + " <a href='mailto:" + objSubCompany.EmailAddress + "'>" + objSubCompany.EmailAddress + "</a> Customer Support Phone:" + objSubCompany.TelephoneNo + "</p>");
                            
                            
                            // Terms and conditions
                            StrBld.Append("<p style='font-size: 18px; color: #666; margin-top: 20px; border-top: 1px solid #eee; padding-top: 10px;color:#6CB6D9'>Orders are subject to our current terms & conditions. We welcome all comments on the services that we provide.</p>");


                            // Continue with the rest of your table content...
                            StrBld.Append("</div>");
                        }
                        else if (obj2.BookingStatusId.ToInt() == 3)
                        {
                            StrBld.Append("<div style='font-family: Calibri, Arial; font-size:13px; color:#333;'>");

                            // Greeting and message
                            StrBld.Append("<p>Dear " + obj2.CustomerName.ToStr() + ",</p>");
                            StrBld.Append("<p>We’re sorry to inform you that your taxi booking could not be accepted at this time due to high demand and scheduling conflict.</p>");
                            StrBld.Append("<p>Please try booking again later or contact our support team for assistance — we’ll be glad to help arrange an alternative as soon as possible.</p>");
                            StrBld.Append("<p>We apologize for the inconvenience and appreciate your understanding.</p>");

                            StrBld.Append("<br>");
                            StrBld.Append("<p>Kind regards,<br>");
                            StrBld.Append("<b>" + objSubCompany.CompanyName + " Team</b><br>");
                            StrBld.Append("<a href='mailto:" + objSubCompany.EmailAddress + "'>" + objSubCompany.EmailAddress + "</a><br>");
                            StrBld.Append("Customer Support Phone:" + objSubCompany.TelephoneNo + "</p>");

                            StrBld.Append("<table width='100%' border='0' cellspacing='0' cellpadding='0' style='border-collapse: collapse; font-family: Arial; font-size: 14px; color: #333; margin-top: 10px;'>");

                            // Title Row
                            StrBld.Append("<tr>");
                            StrBld.Append("<td colspan='2' style='background-color: #f3f6fa; padding: 10px; font-size: 16px; font-weight: bold; border: 1px solid #d4e0ee;'>Booking Details</td>");
                            StrBld.Append("</tr>");

                            // Booking Reference No
                            StrBld.Append("<tr>");
                            StrBld.Append("<td width='40%' style='padding: 8px; border: 1px solid #d4e0ee; font-weight: bold;'>Booking Reference No.</td>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee;'>" + obj2.BookingNo.ToString() + "</td>");
                            StrBld.Append("</tr>");

                            // Passenger Name
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee; font-weight: bold;'>Passenger Name</td>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee;'>" + obj2.CustomerName + "</td>");
                            StrBld.Append("</tr>");

                            // Passenger PhoneNo
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee; font-weight: bold;'>Passenger Phone No.</td>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee;'>" + obj2.CustomerPhoneNo + "</td>");
                            StrBld.Append("</tr>");

                            // Passenger MobileNo
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee; font-weight: bold;'>Passenger Mobile No.</td>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee;'>" + obj2.CustomerMobileNo + "</td>");
                            StrBld.Append("</tr>");

                            // Pick Up Point
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee; font-weight: bold;'>Pick Up Point</td>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee;'>" + obj2.FromAddress + "</td>");
                            StrBld.Append("</tr>");

                            // Drop Off Point
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee; font-weight: bold;'>Drop Off Point</td>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee;'>" + obj2.ToAddress + "</td>");
                            StrBld.Append("</tr>");

                            // Collection Date & Time
                            StrBld.Append("<tr>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee; font-weight: bold;'>Collection Date & Time</td>");
                            StrBld.Append("<td style='padding: 8px; border: 1px solid #d4e0ee;'>" + string.Format("{0:dd/MM/yyyy HH:mm}", obj2.PickupDateTime) + "</td>");
                            StrBld.Append("</tr>");
            ...
            catch (Exception ex)
            {
                try
                {
                    ...
                    System.IO.File.AppendAllText(AppContext.BaseDirectory + "\\" + "SendOnlineBookingmail.txt", DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss") + ",json:" + new JavaScriptSerializer().Serialize(obj) + ",exception:" + ex.Message + Environment.NewLine);
                }
                catch
                {
