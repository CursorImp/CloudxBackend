    ...
    public class Global : System.Web.HttpApplication
    {
            ...
            try
            {
                var requiredSettings = new List<AppSetting>
                            ...
                            new AppSetting { SetKey = "DisableClearDriverDoc", SetVal = "false", description = "DisableClearDriverDoc"  },
                             ...
                             new AppSetting { SetKey = "EnableOptimizeRoute", SetVal = "false", description = "EnableOptimizeRoute"  },
                             ...
                             new AppSetting { SetKey = "EnableSortingForOnJobDriver", SetVal = "false", description = "EnableSortingForOnJobDriver"  },
                        };
        ...
        private void sendSMS(Object source, System.Timers.ElapsedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                try
                {
                    File.AppendAllText(physicalPath + "\\exception_SendSMS.txt", DateTime.Now.ToStr() + ": " + ex.Message + "|" +
                        (ex.InnerException?.StackTrace ?? "NoStack") + "|" +
                        (ex.InnerException?.Message ?? "NoInner") + Environment.NewLine);
